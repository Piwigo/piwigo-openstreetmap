...
$lang['TOP'] = "Same window";
$lang['BLANK'] = "New window";
$lang['LEFTPOPUPCLICKTARGET'] = "Where should page with image open";
$lang['LEFTPOPUPCLICKTARGET_DESC'] = "Select target for image page when clicking on a popup. Default is new window.";
...
$lang['NOGPXFORSUBCAT'] = 'Hide gpx tracks of sub-categories';
$lang['NOGPXFORSUBCAT_DESC'] = "Should gpx tracks of sub-categories be hidden in a category's map? Default is no.";
$lang['FIRSTIMAGEFORSUBCAT'] = 'Show only first image of sub-categories';
$lang['FIRSTIMAGEFORSUBCAT_DESC'] = "Should only the first image of sub-categories be shown in a category's map? Default is no.";
