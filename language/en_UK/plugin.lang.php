...
$lang['LEFTPOPUP_DESC'] = "Show a popup window if you click to the pin.";
...
$lang['CUSTOMBASELAYER_DESC'] = "Only if choosed 'custom' as map style. Who delivers the map style (tiles)?";
$lang['CUSTOMBASELAYERURL'] = "Tile server URL";
$lang['CUSTOMBASELAYERURL_DESC'] = "Only if choosed 'custom' as map style. Example: http://tile.openstreetmap.org/{z}/{x}/{y}.png";
...
$lang['PIN'] = "Select pin";
$lang['PIN_DESC'] = "Select the last option if wonna use your own.";
...
$lang['PINSHADOWPATH_DESC'] = "Path to the image of the shadow of your pin.";
...
$lang['PINOFFSET_DESC'] = "The position on the pin image, where the pin hits the map. 0x0 ist the top-left corner. Example: crosshairs = center of the image";
